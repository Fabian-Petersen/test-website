"use server";
// This icon was created to test the rendering of custom SVG icons on the page to change color of the fill property based on prefer color mode css media query.
